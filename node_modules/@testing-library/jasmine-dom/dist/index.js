...
var _toHaveAttribute = require("./toHaveAttribute");
var _toHaveTextContent = require("./toHaveTextContent");
var _toHaveClassName = require("./toHaveClassName");
var _toBeChecked = require("./toBeChecked");
var _toBeEmptyDOMElement = require("./toBeEmptyDOMElement");
var _toContainHTML = require("./toContainHTML");
var _toHaveFocus = require("./toHaveFocus");
var _toBeDisabled = require("./toBeDisabled");
var _toHaveAccessibleDescription = require("./toHaveAccessibleDescription");
var _toHaveAccessibleName = require("./toHaveAccessibleName");
var _toHaveDescription = require("./toHaveDescription");
var _toHaveValue = require("./toHaveValue");
var _toHaveFormValues = require("./toHaveFormValues");
var _toHaveErrorMessage = require("./toHaveErrorMessage");
var _toContainElement = require("./toContainElement");
var _toBeRequired = require("./toBeRequired");
var _toBeInvalid = require("./toBeInvalid");
var _toHaveDisplayValue = require("./toHaveDisplayValue");
var _toBePartiallyChecked = require("./toBePartiallyChecked");
var _toBeInTheDocument = require("./toBeInTheDocument");
var _toBeVisible = require("./toBeVisible");
var _toHaveStyle = require("./toHaveStyle");
var JasmineDOM = {
